...
async function main() {
  ...
  const coursesData = [
    ...
    },
    {
      ...
      duration: "۴۵ ساعت",
      published: true,
      thumbnail: "/courses/algebra10.jpg",
    },
    {
      ...
      duration: "۳۸ ساعت",
      published: true,
      thumbnail: "/courses/geometry10.jpg",
    },
    {
      title: "حسابان یازدهم",
      ...
      duration: "۵۰ ساعت",
      published: true,
      thumbnail: "/courses/calculus11.jpg",
    },
    {
      title: "هندسه یازدهم",
      ...
      duration: "۴۲ ساعت",
      published: true,
      thumbnail: "/courses/geometry11.jpg",
    },
    {
      ...
      duration: "۳۵ ساعت",
      published: false,
      thumbnail: "/courses/discrete12.jpg",
    },
  ];
